...
public class ChainRead extends AbstractSqlRead<ChainVO> {
  ...
  protected ChainVO parse(ResultSet rs) throws SQLException {
    ...
    String tenantId = getStringFromRsWithCheck(rs, "tenant_id");
    String chainId = getStringFromRsWithCheck(rs, super.config.getChainNameField());
    chainId = chainId + "_" + tenantId;
    chainVO.setChainId(chainId);
  ...
  public String buildQuerySql() {
    ...
    return StrUtil.format(sql, chainTableName, chainApplicationNameField, applicationName);
  }
