package com.yiruantong.common.log.aspect;
...
import com.yiruantong.common.log.enums.BusinessStatus;
...
public class LogAspect {
  ...
  private void setRequestValue(JoinPoint joinPoint, OperLogEvent operLog, String[] excludeParamNames) throws Exception {
    ...
    if (MapUtil.isEmpty(paramsMap) && methods.stream().anyMatch(item -> StringUtils.equals(item, requestMethod))) {
      String params = argsArrayToString(joinPoint.getArgs(), excludeParamNames);
      operLog.setOperParam(params);
    } else if (MapUtil.isEmpty(paramsMap) && HttpMethod.DELETE.name().equals(requestMethod)) {
      var request = ServletUtils.getRequest();
      String params = ObjectUtil.isNull(request) ? argsArrayToString(joinPoint.getArgs(), excludeParamNames) : ServletUtils.getBody(request);
      operLog.setOperParam(params);
    } else {
