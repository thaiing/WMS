package com.yiruantong.common.excel.utils;
...
import com.yiruantong.common.excel.convert.ExcelBigNumberConvert;
import com.yiruantong.common.excel.core.*;
...
public class ExcelUtil {
   ...
   * @return 转换后集合
   */
  public static <T> ExcelResult<T> importExcel(InputStream is, ExcelListener<T> listener, Integer headRowNumber) {
    if (headRowNumber == null) headRowNumber = 1;

    EasyExcel.read(is, listener).sheet().headRowNumber(headRowNumber).doRead();
    return listener.getExcelResult();
  }
  ...
  public static <T> ExcelResult<T> importExcel(InputStream is, ExcelListener<T> listener) {
    return importExcel(is, listener, 1);
  }
  ...
  public static String convertByExp(String propertyValue, String converterExp, String separator) {
    ...
    String[] convertSource = converterExp.split(StringUtils.SEPARATOR_COMMA);
