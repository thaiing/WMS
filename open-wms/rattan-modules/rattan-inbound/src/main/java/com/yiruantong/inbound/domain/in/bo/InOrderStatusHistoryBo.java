...
/**
 * 采购订单流水记录业务对象 in_order_status_history
 *
 * @author YiRuanTong
 * @date 2023-10-20
 */
...
@AutoMapper(target = InOrderStatusHistory.class, reverseConvertGenerate = false)
public class InOrderStatusHistoryBo extends BaseEntity {
