...
/**
 * 入库计划状态轨迹视图对象 in_order_plan_status_history
 *
 * @author YRT
 * @date 2024-09-19
 */
...
@AutoMapper(target = InOrderPlanStatusHistory.class)
public class InOrderPlanStatusHistoryVo implements Serializable {
