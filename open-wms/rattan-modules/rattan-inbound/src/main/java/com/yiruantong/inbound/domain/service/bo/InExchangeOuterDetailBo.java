...
/**
 * 换货单出库明细业务对象 in_exchange_outer_detail
 *
 * @author YiRuanTong
 * @date 2023-10-22
 */
...
@AutoMapper(target = InExchangeOuterDetail.class, reverseConvertGenerate = false)
public class InExchangeOuterDetailBo extends BaseEntity {
