...
@AutoMapper(target = MagicPageBackup.class, reverseConvertGenerate = false)
public class MagicPageBackupBo extends BaseEntity {

  /**
   * 备份ID
   */
  @NotNull(message = "备份ID不能为空", groups = {AddGroup.class, EditGroup.class})
