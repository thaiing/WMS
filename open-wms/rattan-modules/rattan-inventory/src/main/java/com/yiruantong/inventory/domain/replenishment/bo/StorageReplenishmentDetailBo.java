...
/**
 * 补货单明细业务对象 storage_replenishment_detail
 *
 * @author YRT
 * @date 2024-10-14
 */
...
@AutoMapper(target = StorageReplenishmentDetail.class, reverseConvertGenerate = false)
public class StorageReplenishmentDetailBo extends BaseEntity {

  /**
   * 补货单明细ID
   */
  @NotNull(message = "补货单明细ID不能为空", groups = {AddGroup.class, EditGroup.class})
   ...
   * 补货数量
   */
  @NotNull(message = "补货数量不能为空", groups = {AddGroup.class, EditGroup.class})
   ...
   * 已补货数量
   */
  @NotNull(message = "已补货数量不能为空", groups = {AddGroup.class, EditGroup.class})
   ...
   * 原货位
   */
  @NotBlank(message = "原货位不能为空", groups = {AddGroup.class, EditGroup.class})
