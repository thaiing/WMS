...
/**
 * 盈亏单明细视图对象 storage_profit_loss_detail
 *
 * @author YRT
 * @date 2024-09-06
 */
...
@AutoMapper(target = StorageProfitLossDetail.class)
public class StorageProfitLossDetailVo implements Serializable {
   ...
   * 初盘差异(生成盈亏单的时候计算出来的？)
   */
  @ExcelProperty(value = "初盘差异(生成盈亏单的时候计算出来的？)")
  private BigDecimal checkDiff;

  /**
   * 复盘数量
   */
  @ExcelProperty(value = "复盘数量")
  private BigDecimal reCheckQuantity;

  /**
   * 复盘差异
   */
  @ExcelProperty(value = "复盘差异")
