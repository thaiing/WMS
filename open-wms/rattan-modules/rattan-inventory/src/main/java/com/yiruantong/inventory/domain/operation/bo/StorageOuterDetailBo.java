...
/**
 * 盘点单明细业务对象 storage_outer_detail
 *
 * @author YRT
 * @date 2024-11-01
 */
...
@AutoMapper(target = StorageOuterDetail.class, reverseConvertGenerate = false)
public class StorageOuterDetailBo extends BaseEntity {
