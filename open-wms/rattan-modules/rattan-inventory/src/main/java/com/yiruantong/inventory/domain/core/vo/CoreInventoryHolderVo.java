...
@AutoMapper(target = CoreInventoryHolder.class)
public class CoreInventoryHolderVo implements Serializable {
   ...
   * 预占数量
   */
  @ExcelProperty(value = "预占数量")
  private BigDecimal holderStorage;

  /**
   * 原始占位量
   */
  @ExcelProperty(value = "原始占位量")
  private BigDecimal orignHolderStorage;

  /**
   * 退货对冲量
   */
  @ExcelProperty(value = "退货对冲量")
   ...
   * 预占位重量
   */
  @ExcelProperty(value = "预占位重量")
  private BigDecimal holderWeight;

  /**
   * 原始占位重量
   */
  @ExcelProperty(value = "原始占位重量")
