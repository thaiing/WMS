...
/**
 * 其他出库规则视图对象 storage_outer_sorting_rule
 *
 * @author YRT
 * @date 2023-12-20
 */
...
@AutoMapper(target = StorageOuterSortingRule.class)
public class StorageOuterSortingRuleVo implements Serializable {
