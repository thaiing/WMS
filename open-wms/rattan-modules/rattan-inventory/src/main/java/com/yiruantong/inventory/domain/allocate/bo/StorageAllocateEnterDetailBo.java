...
/**
 * 调拨入库单明细业务对象 storage_allocate_enter_detail
 *
 * @author YRT
 * @date 2023-12-20
 */
...
@AutoMapper(target = StorageAllocateEnterDetail.class, reverseConvertGenerate = false)
public class StorageAllocateEnterDetailBo extends BaseEntity {

  /**
   * 调拨入库明细ID
   */
  @NotNull(message = "调拨入库明细ID不能为空", groups = {AddGroup.class, EditGroup.class})
