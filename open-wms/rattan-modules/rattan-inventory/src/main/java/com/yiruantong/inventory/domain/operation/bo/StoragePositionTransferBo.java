...
/**
 * 货位转移业务对象 storage_position_transfer
 *
 * @author YRT
 * @date 2023-12-18
 */
...
@AutoMapper(target = StoragePositionTransfer.class, reverseConvertGenerate = false)
public class StoragePositionTransferBo extends BaseEntity {

  /**
   * 货位转移ID
   */
  @NotNull(message = "货位转移ID不能为空", groups = {AddGroup.class, EditGroup.class})
  private Long transferId;

  /**
   * 货位转移单号
   */
  @NotBlank(message = "货位转移单号不能为空", groups = {AddGroup.class, EditGroup.class})
   ...
   * 转移状态
   */
  @NotBlank(message = "转移状态不能为空", groups = {AddGroup.class, EditGroup.class})
