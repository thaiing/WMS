...
@AutoMapper(target = BasePlateIn.class)
public class BasePlateInVo implements Serializable {
   ...
   * 送货订单号
   */
  @ExcelProperty(value = "送货订单号")
  private String deliveryCode;

  /**
   * 容器借出单id
   */
  @ExcelProperty(value = "容器借出单id")
  private Long outId;
