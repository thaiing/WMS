...
/**
 * 容器归还费用明细业务对象 base_plate_in_cost
 *
 * @author YRT
 * @date 2024-04-08
 */
...
@AutoMapper(target = BasePlateInCost.class, reverseConvertGenerate = false)
public class BasePlateInCostBo extends BaseEntity {

  /**
   * 费用明细id
   */
  @NotNull(message = "费用明细id不能为空", groups = {AddGroup.class, EditGroup.class})
  private Long costId;
