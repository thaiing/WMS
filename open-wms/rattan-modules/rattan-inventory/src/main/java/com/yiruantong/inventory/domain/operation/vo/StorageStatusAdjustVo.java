...
/**
 * 状态属性调整视图对象 storage_status_adjust
 *
 * @author YRT
 * @date 2025-02-14
 */
...
@AutoMapper(target = StorageStatusAdjust.class)
public class StorageStatusAdjustVo implements Serializable {
