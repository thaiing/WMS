...
/**
 * 货位转移视图对象 storage_position_transfer
 *
 * @author YRT
 * @date 2023-12-18
 */
...
@AutoMapper(target = StoragePositionTransfer.class)
public class StoragePositionTransferVo implements Serializable {
