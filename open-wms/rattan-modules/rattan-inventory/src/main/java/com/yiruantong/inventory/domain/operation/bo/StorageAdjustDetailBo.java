...
/**
 * 库存调整单明细业务对象 storage_adjust_detail
 *
 * @author YRT
 * @date 2024-11-02
 */
...
@AutoMapper(target = StorageAdjustDetail.class, reverseConvertGenerate = false)
public class StorageAdjustDetailBo extends BaseEntity {
