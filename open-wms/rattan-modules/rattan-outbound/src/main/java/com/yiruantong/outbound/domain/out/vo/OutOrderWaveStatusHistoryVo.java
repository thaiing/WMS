...
/**
 * 订单状态历史记录视图对象 out_order_wave_status_history
 *
 * @author YRT
 * @date 2023-11-24
 */
...
@AutoMapper(target = OutOrderWaveStatusHistory.class)
public class OutOrderWaveStatusHistoryVo implements Serializable {
