...
/**
 * 订单状态历史记录业务对象 out_order_wave_status_history
 *
 * @author YRT
 * @date 2023-11-24
 */
...
@AutoMapper(target = OutOrderWaveStatusHistory.class, reverseConvertGenerate = false)
public class OutOrderWaveStatusHistoryBo extends BaseEntity {
