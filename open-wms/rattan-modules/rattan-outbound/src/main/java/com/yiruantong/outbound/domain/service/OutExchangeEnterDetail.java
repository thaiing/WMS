...
/**
 * 换货管理Enter明细对象 out_exchange_enter_detail
 *
 * @author YiRuanTong
 * @date 2024-11-21
 */
...
@TableName(value = "out_exchange_enter_detail", autoResultMap = true)
public class OutExchangeEnterDetail extends TenantEntity {
