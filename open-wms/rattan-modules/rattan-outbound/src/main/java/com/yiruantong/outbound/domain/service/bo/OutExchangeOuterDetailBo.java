...
/**
 * 换货管理Outer明细业务对象 out_exchange_outer_detail
 *
 * @author YiRuanTong
 * @date 2024-11-21
 */
...
@AutoMapper(target = OutExchangeOuterDetail.class, reverseConvertGenerate = false)
public class OutExchangeOuterDetailBo extends BaseEntity {
