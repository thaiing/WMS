...
@AutoMapper(target = OutReturn.class, reverseConvertGenerate = false)
public class OutReturnBo extends BaseEntity {
   ...
   * 仓管状态
   */
  @NotBlank(message = "仓管状态不能为空", groups = {AddGroup.class, EditGroup.class})
