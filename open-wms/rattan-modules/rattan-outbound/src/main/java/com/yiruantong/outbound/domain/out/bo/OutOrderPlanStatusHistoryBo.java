...
/**
 * 出库计划状态轨迹业务对象 out_order_plan_status_history
 *
 * @author YRT
 * @date 2024-09-20
 */
...
@AutoMapper(target = OutOrderPlanStatusHistory.class, reverseConvertGenerate = false)
public class OutOrderPlanStatusHistoryBo extends BaseEntity {
