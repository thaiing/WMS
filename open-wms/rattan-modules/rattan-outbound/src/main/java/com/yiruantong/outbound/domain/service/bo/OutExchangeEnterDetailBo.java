...
/**
 * 换货管理Enter明细业务对象 out_exchange_enter_detail
 *
 * @author YiRuanTong
 * @date 2024-11-21
 */
...
@AutoMapper(target = OutExchangeEnterDetail.class, reverseConvertGenerate = false)
public class OutExchangeEnterDetailBo extends BaseEntity {
