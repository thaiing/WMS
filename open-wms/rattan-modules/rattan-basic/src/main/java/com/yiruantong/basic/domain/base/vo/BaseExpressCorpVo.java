...
@AutoMapper(target = BaseExpressCorp.class)
public class BaseExpressCorpVo implements Serializable {
   ...
   * 快递英文名
   */
  @ExcelProperty(value = "快递英文名")
  private String expressCorpEnName;

  /**
   * 快递类型
   */
  @ExcelProperty(value = "快递类型")
   ...
   * 发货后导入快递单
   */
  @ExcelProperty(value = "发货后导入快递单")
  private Byte isAfterImportExpress;

  /**
   * 按件数打印
   */
  @ExcelProperty(value = "按件数打印")
  private Byte isExpressCorp;

  /**
   * 显示提交按钮
   */
  @ExcelProperty(value = "显示提交按钮")
  private Byte isShowSubmit;

  /**
   * 按件数打印并提交
   */
  @ExcelProperty(value = "按件数打印并提交")
  private Byte isExpressCorpSubmit;

  /**
   * 自动生成装箱单
   */
  @ExcelProperty(value = "自动生成装箱单")
  private Byte isCreatePackage;

  /**
   * 运费计算模板ID
   */
  @ExcelProperty(value = "运费计算模板ID")
  private Long freightTemplateId;

  /**
   * 运费计算模板
   */
  @ExcelProperty(value = "运费计算模板")
  private String freightTemplateName;

  /**
   * 返回标志
   */
  @ExcelProperty(value = "返回标志")
   ...
   * 日最小送货量
   */
  @ExcelProperty(value = "日最小送货量")
  private Long minQuantity;

  /**
   * 日最大送货量
   */
  @ExcelProperty(value = "日最大送货量")
  private Long maxQuantity;

  /**
   * 从接口获得跟踪单号
   */
  @ExcelProperty(value = "从接口获得跟踪单号")
  private Long interfaceCode;

  /**
   * 站点网址
   */
  @ExcelProperty(value = "站点网址")
  private String siteUrl;

  /**
   * 声音地址
   */
  @ExcelProperty(value = "声音地址")
  private String soundUrl;

  /**
   * 最小申报价值
   */
  @ExcelProperty(value = "最小申报价值")
  private BigDecimal minDeclareValue;

  /**
   * 最大申报价值
   */
  @ExcelProperty(value = "最大申报价值")
   ...
   * 关联接口账号ID
   */
  @ExcelProperty(value = "关联接口账号ID")
  private String interfaceAccountId;

  /**
   * 关联接口账号
   */
  @ExcelProperty(value = "关联接口账号")
   ...
   * 销售订单模板详情ID
   */
  @ExcelProperty(value = "销售订单模板详情ID")
  private Long saleOrderPrintTemplateId;

  /**
   * 销售订单模板详情
   */
  @ExcelProperty(value = "销售订单模板详情")
