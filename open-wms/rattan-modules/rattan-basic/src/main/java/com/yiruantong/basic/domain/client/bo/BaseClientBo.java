...
@AutoMapper(target = BaseClient.class, reverseConvertGenerate = false)
public class BaseClientBo extends BaseEntity {
   ...
   * 客户全称
   */
  @NotBlank(message = "客户全称不能为空", groups = {AddGroup.class, EditGroup.class})
