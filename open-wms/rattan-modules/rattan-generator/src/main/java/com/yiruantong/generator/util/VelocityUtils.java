...
public class VelocityUtils {
  ...
  public static VelocityContext prepareContext(GenTable genTable) {
    ...
    velocityContext.put("projectName", projectName); // 项目名称

    String folderName = Optional.ofNullable(genTable.getModuleName()).filter(f -> !f.isEmpty()).map(m -> "." + m).orElse("");
    velocityContext.put("folderName", folderName); // 文件夹名称
    ...
    velocityContext.put("RandomUtil", new RandomUtil());
