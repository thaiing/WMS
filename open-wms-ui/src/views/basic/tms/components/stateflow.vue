<template>
	<el-popover placement="right-start" title="任务状态" width="650" trigger="click" class="state-flow" @show="loadData">
		...
		<el-table :data="state.tableData" :max-height="200" size="small" style="width: 100%">
			...
			<el-table-column prop="orderStatus" label="单据状态"></el-table-column>
