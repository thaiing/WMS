...
<template>
  <div class="config-container">
    ...
    <el-tabs v-model="state.tabActive" class="tabs-container">
      <el-tab-pane label="折线图设置" name="t1" class="tab-pane">
          ...
          <div class="block-group">
            ...
            <draggable :list="config.series" item-key="title" class="series-box" :animation="300" tag="div" :component-data="{ name: 'fade' }" handle=".cursor-move" group="config" ghost-class="ghost-item" chosen-class="chosen-item" drag-class="drag-item">
              <template #item="{ element, index }">
                <el-form ref="formRef" :model="element" label-width="80px" class="item-row">
                  ...
                  <el-row :gutter="20">
                    <el-col :span="12">
                      <el-form-item label="线颜色" :label-width="110">
                        <el-color-picker v-model="element.lineStyleColor" :predefine="predefineColors" show-alpha />
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item label="高亮状态" :label-width="110">
                        <el-select v-model="element.emphasisFocus" clearable filterable allow-create default-first-option :reserve-keyword="false" style="width: 100%">
                          <el-option label="不淡出其它图形" value="none" />
                          <el-option label="只聚焦" value="self" />
                          <el-option label="聚焦当前高亮" value="series" />
                        </el-select>
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row :gutter="20">
                    <el-col :span="12">
                      <el-form-item label="拐点颜色" :label-width="110">
                        <el-color-picker v-model="element.itemStyleColor" :predefine="predefineColors" show-alpha />
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item label="拐点描边颜色" :label-width="110">
                        <el-color-picker v-model="element.itemStyleBorderColor" :predefine="predefineColors" show-alpha />
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row :gutter="20">
                    <el-col :span="12">
                      <el-form-item label="区域渐变色1" :label-width="110">
                        <el-color-picker v-model="element.areaStyleColor1" :predefine="predefineColors" show-alpha />
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item label="区域渐变色2" :label-width="110">
                        <el-color-picker v-model="element.areaStyleColor2" :predefine="predefineColors" show-alpha />
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-form-item :label-width="12">
                    <el-button @click="delItem(element, index)">删除折线</el-button>
                  </el-form-item>
                </el-form>
              </template>
            </draggable>
            <el-button type="primary" plain class="w-100pc margin-top-10" @click="addItem">添加折线</el-button>
          </div>
