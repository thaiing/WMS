  ...
  <div class="config-container">
    ...
    <el-tabs v-model="tabActive" class="tabs-container">
      <el-tab-pane label="内容设置" name="t1" class="tab-pane">
        ...
        <draggable :list="config.items" item-key="title" class="item-row" :animation="300" tag="el-row" handle=".col-icon" group="config" animation="600" ghost-class="ghost-item" chosen-class="chosen-item" drag-class="drag-item">
