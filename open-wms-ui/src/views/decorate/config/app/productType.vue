  ...
  <div class="config-container">
    ...
    <el-tabs v-model="tabActive" class="tabs-container">
      <el-tab-pane label="内容设置" name="t1" class="tab-pane">
        ...
        <draggable :list="config.items" item-key="title" class="item-row" :animation="300" tag="div" handle=".col-icon" group="config" animation="600" ghost-class="ghost-item" chosen-class="chosen-item" drag-class="drag-item">
              ...
              <el-col :span="22">
                <el-form ref="formRef" :model="element" label-width="80px">
                  ...
                  <el-form-item label="默认选中">
                    <el-switch v-model="element.isDefault" @change="defaultChange(element)" />
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
