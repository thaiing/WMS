  ...
  <div class="config-container">
    ...
    <el-tabs v-model="tabActive" class="tabs-container">
      <el-tab-pane label="内容设置" name="t1" class="tab-pane">
        <el-alert title="设置logo，最多可添加1张图片，建议宽度130 * 36px" type="info" show-icon class="margin-bottom-10" :closable="false"></el-alert>
        <el-image class="img" :src="config.image" :initial-index="1" fit="contain" @click.stop.prevent="selectFile()">
          <template #error>
      ...
      <el-tab-pane label="样式设置" name="t2" class="tab-pane">
        <el-form ref="formRef" :model="config.style" label-width="100px" @submit.prevent>
          <el-form-item label="logo宽">
            <el-row :gutter="5">
              <el-col :span="18" class="padding-left-5">
                <el-slider v-model.number="config.style.logoWidth"></el-slider>
              </el-col>
              <el-col :span="6">
                <el-input v-model.number="config.style.logoWidth" class="w-50" />
              </el-col>
            </el-row>
          </el-form-item>
          <el-form-item label="logo高">
            <el-row :gutter="5">
              <el-col :span="18" class="padding-left-5">
                <el-slider v-model.number="config.style.logoHeight"></el-slider>
              </el-col>
              <el-col :span="6">
                <el-input v-model.number="config.style.logoHeight" class="w-50" />
              </el-col>
            </el-row>
          </el-form-item>
          ...
          <el-form-item label="背景颜色">
            <el-color-picker v-model="config.style.bgColor" show-alpha />
          </el-form-item>
          <el-form-item label="文字颜色">
            <el-color-picker v-model="config.style.color" show-alpha />
          </el-form-item>
          <el-form-item label="背景样式">
            <el-radio-group v-model="config.style.borderRadius">
              <el-radio-button label="直角"></el-radio-button>
          ...
          <el-form-item label="背景边距">
            <el-row :gutter="5">
              ...
              <el-col :span="6">
                <el-input v-model.number="config.style.bgPadding" class="w-50" />
              </el-col>
            </el-row>
          </el-form-item>
          <el-form-item label="页面间距">
            <el-row :gutter="5">
              ...
              <el-col :span="6">
                <el-input v-model.number="config.style.maginTop" class="w-50" />
              </el-col>
            </el-row>
          </el-form-item>
        </el-form>
