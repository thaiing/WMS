    ...
    <el-tabs v-model="tabActive" class="tabs-container">
      <el-tab-pane label="参数设置" name="t1" class="tab-pane">
        <el-form ref="formRef" :model="config" label-width="100px">
          ...
          <el-form-item label="值宽度">
            <el-input v-model="config.valueWidth"></el-input>
          </el-form-item>
          ...
          <el-form-item label="格式化">
            <el-select v-model="config.formatter" style="width: 100%" clearable>
          ...
          <el-form-item label="单位">
            <el-input v-model="config.unit"></el-input>
          </el-form-item>
          ...
          <el-form-item label="隐藏标题">
            <el-switch v-model="config.hiddenLabel" :active-value="true" :inactive-value="false"></el-switch>
          </el-form-item>
        </el-form>
      </el-tab-pane>
