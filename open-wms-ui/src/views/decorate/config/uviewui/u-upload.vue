      ...
      <el-tab-pane label="参数设置" name="t1" class="tab-pane">
        <el-form ref="formRef" :model="config" label-width="100px">
          <el-form-item label="标题">
            <el-input v-model="config.options.label" link></el-input>
          </el-form-item>
          <el-form-item label="绑定字段">
            <el-input v-model="config.options.prop"></el-input>
          </el-form-item>
          ...
          <el-form-item label="宽度">
            <el-input v-model="config.options.width" link></el-input>
          </el-form-item>
          <el-form-item label="高度">
            <el-input v-model="config.options.height" link></el-input>
          </el-form-item>
          <el-form-item label="最大文件数">
            <el-input v-model.number="config.options.maxCount" link></el-input>
          </el-form-item>
          <el-form-item label="文件多选">
            <el-switch v-model="config.options.multiple"> </el-switch>
          </el-form-item>
...
import getCommon from './hooks/common.ts';

export default {
  name: 'app-config-u-button',
  components: {
    draggable,
    filerDialog,
    linkerDialog,
