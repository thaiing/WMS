      ...
      <el-tab-pane label="参数设置" name="t1" class="tab-pane">
        <el-form ref="formRef" :model="config" label-width="100px">
          ...
          <el-form-item label="图标">
            <el-input v-model="config.options.icon" link></el-input>
          </el-form-item>
          <el-form-item label="权限点名称">
            <el-input v-model="config.options.authNode" link></el-input>
          </el-form-item>
          <el-form-item label="按钮宽度">
            <el-input v-model="config.options.width" link></el-input>
          </el-form-item>
          <el-form-item label="按钮类型">
            <el-select v-model="config.options.type">
          ...
          <el-form-item label="镂空">
            <el-switch v-model="config.options.plain"> </el-switch>
          </el-form-item>
        </el-form>
      </el-tab-pane>
