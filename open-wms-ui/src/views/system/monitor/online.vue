<template>
	<div class="p-2">
		...
		<el-card shadow="hover">
			<el-table v-loading="loading" :data="onlineList.slice((queryParams.pageIndex - 1) * queryParams.pageSize, queryParams.pageIndex * queryParams.pageSize)" style="width: 100%">
...
<script setup name="system-monitor-online" lang="ts">
