		...
		<el-row>
			...
			<el-col :span="12">
				<el-form-item>
					...
					<el-tree-select v-model="infoForm.parentMenuId" :data="menuOptions" :props="{ value: 'menuId', label: 'menuName', children: 'children' }" placeholder="请选择系统菜单" check-strictly />
				</el-form-item>
			</el-col>
			...
			<el-col :span="12">
				<el-form-item prop="parentId">
					<template #label>
						父级ID
						<el-tooltip content="用于维护树形目录结构" placement="top">
							<el-icon><question-filled /></el-icon>
						</el-tooltip>
					</template>
					<el-input v-model="infoForm.parentId" />
				</el-form-item>
			</el-col>
				...
				<el-col :span="12">
					<el-form-item>
						...
						<el-select v-model="infoForm.treeParentCode" placeholder="请选择">
							<el-option v-for="(column, index) in infoForm.columns" :key="index" :label="column.columnName + '：' + column.columnComment" :value="column.columnName"></el-option>
						</el-select>
					</el-form-item>
				</el-col>
				<el-col :span="12">
