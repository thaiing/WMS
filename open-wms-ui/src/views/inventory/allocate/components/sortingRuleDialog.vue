...
const getSortingRuleList = async () => {
  const allocateApplyDetailId = state.allocateApplyDetailId;
  const url = '/inventory/allocate/allocateApply/getSortingRule';
  const params = { orderDetailId: allocateApplyDetailId };
...
const submitSortingRuleData = async () => {
  ...
  const allocateApplyId = props.masterData.value.allocateApplyId;
  const allocateApplyCode = props.masterData.value.allocateApplyCode;
  ...
  const url = '/inventory/allocate/allocateApply/setSortingRule';
  const params = {
    ...
    orderDetailId: allocateApplyDetailId,
    orderId: allocateApplyId,
    orderCode: allocateApplyCode,
...
const deleteRule = async (ruleId: any) => {
  proxy
    ...
    .then(async () => {
      const url = '/inventory/allocate/allocateApply/deleteSortingRule';
...
const elDropdownKeyup = async (val: any) => {
  try {
    ...
    const orderCode = props.masterData.value.allocateApplyCode;
