...
<script setup lang="ts" name="inventory-stat-storageDay">
...
const currentDayStorage = async () => {
	const url = '/composite/statStorageDayComposite/currentDayStorage';
	const params = {};
