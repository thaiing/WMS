...
export default {
	...
	workflow: {
		...
		auditProccess: '审批流程',
		auditComment: '审批意见：',
		auditCommentPlacehoder: '请输入审批意见',
		carbonCopy: '抄送人：',
		...
		flowRecord: '流转记录',
		InitiateFlow: '发起流程',
		actualProcessing: '实际办理',
		candidateProcessing: '候选办理',
		receptionTime: '接收时间',
		completionTime: '办结时间',
		timeConsuming: '耗时',
		endProcess: '结束流程',
		...
		currentNode: '当前审批节点',
		currentAuditor: '当前审批人',
		audtorNoBlank: '当前审批人为空！',
		userNotExist: '用户不存在',
		currentCandidateGroups: '当前候选人组',

		procInsIdNotEmpty: '流程实例ID不能为空！',
	},
	// mes
	mes: {
		// 退料单
		return: {
			isPorduceDate: '请选择明细生产日期！',
			isProvider: '请选择明细供应商！',
			isConsignor: '请选择明细货主！',
			isStorage: '请选择明细仓库！',
			isQty: '退料数量必须大于0！',
