<template>
  <div class="layout-navbars-breadcrumb-user pr15" :style="{ flex: layoutUserFlexNum }">
    ...
    <!-- <div class="layout-navbars-breadcrumb-user-icon" ref="userNewsBadgeRef" v-click-outside="onUserNewsClick">
		...
		<el-popover ref="userNewsRef" :virtual-ref="userNewsBadgeRef" placement="bottom" trigger="click" transition="el-zoom-in-top" virtual-triggering :width="300" :persistent="false">
			<UserNews />
		</el-popover> -->
    ...
    <el-dropdown :show-timeout="70" :hide-timeout="50" @command="onHandleCommandClick">
      ...
      <template #dropdown>
        <el-dropdown-menu>
          ...
          <el-dropdown-item @click="state.modifyPwdVisible = true">修改密码</el-dropdown-item>
...
import { defineAsyncComponent, ref, unref, computed, reactive, onMounted, ComponentInternalInstance, getCurrentInstance } from 'vue';
...
const warning = defineAsyncComponent(() => import('./warning.vue'));
const tenantChange = defineAsyncComponent(() => import('./tenantChange.vue'));
...
let init = async () => {
  ...
  state.goBack = pageConfig.data.goBack;
};

const goBackUrl = () => {
  location.href = state.goBack.url;
};
</script>
