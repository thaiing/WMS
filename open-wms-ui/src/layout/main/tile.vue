<template>
	<el-container class="layout-container">
		...
		<el-container class="layout-container-view h100">
			<el-scrollbar ref="layoutScrollbarRef" class="layout-backtop" @scroll="mainScroll">
				<LayoutHeader />
...
// 引入组件
const LayoutAside = defineAsyncComponent(() => import('/@/layout/component/tileAside.vue'));
...
// 滚动条事件
let mainScroll = (params: any) => {
	let { scrollLeft, scrollTop } = params;
	proxy.mittBus.emit('onMainScroll', { scrollLeft, scrollTop });
};
