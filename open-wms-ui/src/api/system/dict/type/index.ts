...
export function getType(dictId: number | string): AxiosPromise<DictTypeVO> {
	return request({
		url: '/system/core/dictType/' + dictId,
		method: 'get',
	});
}
...
export function refreshCache() {
	return request({
		url: '/system/core/dictType/refreshCache',
		method: 'delete',
	});
}
...
export function optionselect(): AxiosPromise<DictTypeVO[]> {
	return request({
		url: '/system/core/dictType/optionselect',
		method: 'get',
	});
}
