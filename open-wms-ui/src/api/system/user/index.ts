...
export function listUser(query: UserQuery): AxiosPromise<UserVO[]> {
	return request({
		url: '/system/permission/user/list',
		method: 'get',
		params: query,
	});
}
...
export function getUser(userId?: string | number): AxiosPromise<UserInfoVO> {
	return request({
		url: '/system/permission/user/' + parseStrEmpty(userId),
		method: 'get',
	});
}
...
export function resetUserPwd(userId: string | number, password: string) {
	...
	return request({
		url: '/system/permission/user/resetPwd',
		method: 'put',
		data: data,
	});
}
...
export function changeUserStatus(userId: number | string, status: string) {
	...
	return request({
		url: '/system/permission/user/changeStatus',
		method: 'put',
		data: data,
	});
}
...
export function getUserProfile(): AxiosPromise<UserInfoVO> {
	return request({
		url: '/system/permission/user/profile',
		method: 'get',
	});
}
...
export function updateUserPwd(oldPassword: string, newPassword: string) {
	...
	return request({
		url: '/system/permission/user/profile/updatePwd',
		method: 'put',
		params: data,
	});
}
...
export function uploadAvatar(data: FormData) {
	return request({
		url: '/system/permission/user/profile/avatar',
		method: 'post',
		data: data,
	});
}
...
export function getAuthRole(userId: string | number): AxiosPromise<{ user: UserVO; roles: RoleVO[] }> {
	return request({
		url: '/system/permission/user/authRole/' + userId,
		method: 'get',
	});
}
...
export function updateAuthRole(data: { userId: string; roleIds: string }) {
	return request({
		url: '/system/permission/user/authRole',
		method: 'put',
		params: data,
	});
}
...
export function deptTreeSelect(): AxiosPromise<DeptVO[]> {
	return request({
		url: '/system/permission/user/deptTree',
		method: 'get',
		headers: {
			noLoading: true,
		},
